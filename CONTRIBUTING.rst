...
When `reporting a bug <https://github.com/ColinKennedy/ways/issues>`_ please include:
...
To set up `ways` for local development:

1. Fork `ways <https://github.com/ColinKennedy/ways>`_
   (look for the "Fork" button).
2. Clone your fork locally::

    git clone git@github.com:your_name_here/ways.git
